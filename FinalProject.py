...
class PGJanuaryFebuary20:
    ...
    def first_del(self):
        ...
        boardings.to_csv("2020janfeb_topboardings.csv",encoding="utf-8")
        alightings.to_csv("2020janfeb_topalightings.csv",encoding="utf8")
        ...
        todroutes.to_csv("2020janfeb_tophours.csv",encoding="utf-8")
